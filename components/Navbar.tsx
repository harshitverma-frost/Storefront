...
export default function Navbar() {
    ...
    return (
        <header className="w-full">
            ...
            {/* ================= TOP THIN BAR ================= */}
            <div className="text-white text-xs tracking-wide royal-bar bg-gradient-to-r from-[#5A0012] via-[#8B0000] to-[#5A0012]">
                <div className="mx-auto max-w-7xl flex items-center justify-between px-6 py-2">
                    ...
                    <span className="hidden md:block shiny-gold-text text-sm">✦ Thank you for choosing us ✦</span>
                </div>
            </div>
            ...
            {/* ================= BURGUNDY CATEGORY BAR ================= */}
            <div className="sticky top-0 z-50 royal-bar bg-gradient-to-r from-[#5A0012] via-[#8B0000] to-[#5A0012]">
                <div className="mx-auto max-w-7xl px-6">
                    <nav className="flex items-center justify-between h-12 text-white font-medium uppercase tracking-wider text-sm">
                        ...
                        <div className="hidden md:flex items-center gap-1">
                            {categoryLinks.map((link, index) => (
                                <span key={link.href} className="flex items-center">
                                    <Link
                                        href={link.href}
                                        className="relative group transition-all duration-300 px-3 py-1 rounded hover:bg-white/10"
                                    >
                                        <span className="relative z-10 group-hover:text-[#FFD700] transition-colors duration-300">
                                            {link.label}
                                        </span>
                                        <span className="absolute left-1/2 -translate-x-1/2 -bottom-1 w-0 h-[2px] bg-gradient-to-r from-transparent via-[#C6A75E] to-transparent transition-all duration-300 group-hover:w-4/5"></span>
                                    </Link>
                                    {index < categoryLinks.length - 1 && (
                                        <span className="text-[#C6A75E]/40 text-xs select-none">│</span>
                                    )}
                                </span>
                            ))}
                        </div>
                        ...
                        {/* Hotline Right */}
                        <div className="hidden md:flex items-center gap-2 font-semibold tracking-wider">
                            <span className="text-[#C6A75E]">✆</span>
                            <span>Hotline : <span className="text-[#FFD700]">090 202 5806</span></span>
                        </div>
                    </nav>
                </div>
            </div>
